...
impl<R: Record, A: Agent<R>, F: FnMut(A::Error) -> Result<A2, A::Error>, A2: Agent<R>> Agent<R>
    for Catch<A, F>
{
...
impl<R: Record, A: AgentRef<R>, F: Fn(A::Error) -> Result<A2, A::Error>, A2: Agent<R>> AgentRef<R>
    for Catch<A, F>
{
